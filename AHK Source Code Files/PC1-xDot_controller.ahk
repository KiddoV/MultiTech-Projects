...
Gui Add, Button, xs+5 ys+15 w30 h30 vXDot01 gGetXDot hWndhXDot01, P01
Gui Add, Button, xs+37 ys+15 w30 h30 vXDot02 gGetXDot hWndhXDot02, P02
Gui Add, Button, xs+69 ys+15 w30 h30 vXDot03 gGetXDot hWndhXDot03, P03
Gui Add, Button, xs+101 ys+15 w30 h30 vXDot04 gGetXDot hWndhXDot04, P04
Gui Add, Button, xs+133 ys+15 w30 h30 vXDot05 gGetXDot hWndhXDot05, P05
Gui Add, Button, xs+165 ys+15 w30 h30 vXDot06 gGetXDot hWndhXDot06, P06

Gui Add, Button, xs+5 ys+50 w30 h30 vXDot07 gGetXDot hWndhXDot07, P07
Gui Add, Button, xs+37 ys+50 w30 h30 vXDot08 gGetXDot hWndhXDot08, P08
Gui Font
...
Gui Add, Text, xs+115 ys+20 vselectWFwLabel, Fw:
...
SyncModeCheck:
    ...
    if (driveStatus = "Ready") {
        ...
        IniRead, isEcoLabOn, %syncModeFilePath%, Sync, EcoLabOnPC1  ;Remember EcoLabOnPCx is different from other PC
        if (isEcoLabOn != "ERROR" && !isEcoLabCtrlVisible) {
            Menu, OptionMenu, ToggleCheck, Eco Lab Mode
            toggleEcoLabMode()
            IniWrite, ERROR, %syncModeFilePath%, Sync, EcoLabOnPC1
        }
        if (isEcoLabOn != "ERROR" && isEcoLabCtrlVisible) {
            Menu, OptionMenu, ToggleCheck, Eco Lab Mode
            toggleEcoLabMode()
